...
CREATE VIEW [etl].[vw_Load_DimCustomer_SFDCContact]
AS
(
SELECT *,
       /*Name*/
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(FullName), 'DBNULL_TEXT') + ISNULL(RTRIM(Prefix), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(FirstName), 'DBNULL_TEXT') + ISNULL(RTRIM(MiddleName), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(LastName), 'DBNULL_TEXT') + ISNULL(RTRIM(Suffix), 'DBNULL_TEXT')
       ...
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(AddressOneStreet), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressOneSuite), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(AddressOneCity), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressOneState), 'DBNULL_TEXT')
       ...
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(AddressTwoStreet), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressTwoSuite), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(AddressTwoCity), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressTwoState), 'DBNULL_TEXT')
       ...
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(AddressThreeStreet), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressThreeSuite), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(AddressThreeCity), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressThreeState), 'DBNULL_TEXT')
       ...
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(AddressFourStreet), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressFourSuite), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(AddressFourCity), 'DBNULL_TEXT') + ISNULL(RTRIM(AddressFourState), 'DBNULL_TEXT')
       ...
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(Prefix), 'DBNULL_TEXT') + ISNULL(RTRIM(FirstName), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(MiddleName), 'DBNULL_TEXT') + ISNULL(RTRIM(LastName), 'DBNULL_TEXT')
       ...
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(CustomerType), 'DBNULL_TEXT') + ISNULL(RTRIM(CustomerStatus), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(AccountType), 'DBNULL_TEXT') + ISNULL(RTRIM(AccountRep), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(CompanyName), 'DBNULL_TEXT') + ISNULL(RTRIM(SalutationName), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(DonorMailName), 'DBNULL_TEXT') + ISNULL(RTRIM(DonorFormalName), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(Birthday), 'DBNULL_TEXT') + ISNULL(RTRIM(Gender), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(AccountId), 'DBNULL_TEXT') + ISNULL(RTRIM(MergedRecordFlag), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(MergedIntoSSID), 'DBNULL_TEXT') + ISNULL(RTRIM(IsBusiness), 'DBNULL_TEXT')
                ) AS [contactattrDirtyHash],
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(ExtAttribute1), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute2), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute3), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute4), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute5), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute6), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute7), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute8), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute9), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute10), 'DBNULL_TEXT')
                ) AS [extattr1_10DirtyHash],
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(ExtAttribute11), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute12), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute13), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute14), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute15), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute16), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute17), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute18), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute19), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute20), 'DBNULL_TEXT')
                ) AS [extattr11_20DirtyHash],
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(ExtAttribute21), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute22), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute23), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute24), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute25), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute26), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute27), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute28), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute29), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute30), 'DBNULL_TEXT')
                ) AS [extattr21_30DirtyHash],
       HASHBYTES(
                    'sha2_256',
                    ISNULL(RTRIM(ExtAttribute31), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute32), 'DBNULL_TEXT')
                    + ISNULL(RTRIM(ExtAttribute33), 'DBNULL_TEXT') + ISNULL(RTRIM(ExtAttribute34), 'DBNULL_TEXT')
...
*/
    ...
    SELECT DB_NAME() SourceDB,
           'SFDC Contact' SourceSystem,
           ...
           CASE
               WHEN pca.IsPersonAccount = 0 THEN
                   LEFT(pca.Name, 50)
               ELSE
                   NULL
           END AS CompanyName,
           ...
           NULL AS [Suffix],
                                     ...
                                     /*AddressPrimary*/
           pcc.MailingStreet AS [AddressPrimaryStreet],
           pcc.MailingCity AS [AddressPrimaryCity],
           pcc.MailingState AS [AddressPrimaryState],
           pcc.MailingPostalCode AS [AddressPrimaryZip],
           NULL AS [AddressPrimaryCounty],
           pcc.MailingCountry AS [AddressPrimaryCountry],
                                     --, CASE WHEN ISNULL(MailingStreet,'') = '' THEN BillingStreet ELSE ISNULL(MailingStreet, BillingStreet) END AS [AddressPrimaryStreet]
                                     --, CASE WHEN ISNULL(MailingStreet,'') = '' THEN BillingCity ELSE ISNULL(MailingCity, BIllingCity) END AS [AddressPrimaryCity] 
                                     --, CASE WHEN ISNULL(MailingStreet,'') = '' THEN BillingState ELSE ISNULL(MailingState, BillingState)	END AS [AddressPrimaryState] 
                                     --, CASE WHEN ISNULL(MailingStreet,'') = '' THEN BillingPostalCode ELSE ISNULL(MailingPostalCode, BillingPostalCode) END	AS [AddressPrimaryZip] 
                                     --, NULL AS [AddressPrimaryCounty]
                                     --, CASE WHEN ISNULL(MailingStreet,'') = '' THEN BillingCountry ELSE ISNULL([MailingCountry], BillingCountry) END AS [AddressPrimaryCountry] 
           ...
           NULL AS [AddressFourSuite],
                                     /*Phone*/
           NULLIF(CAST(COALESCE(pcc.Phone, pcc.MobilePhone) AS NVARCHAR(25)), '--') AS [PhonePrimary],
           NULLIF(CAST(pcc.Phone AS NVARCHAR(25)), '--') AS [PhoneHome],
           NULLIF(CAST(pcc.MobilePhone AS NVARCHAR(25)), '--') AS [PhoneCell],
           NULL AS [PhoneBusiness],
           NULL AS [PhoneFax],
           NULL AS [PhoneOther],
                                     /*Email*/
           NULLIF(CAST(pcc.Email AS VARCHAR(256)), '--') AS [EmailPrimary],
           NULLIF(CAST(pcc.Email AS VARCHAR(256)), '--') AS [EmailOne],
           NULL AS [EmailTwo],
                                     /*Extended Attributes*/
           NULL AS [ExtAttribute1],  --nvarchar(100)
           NULL AS [ExtAttribute2],
           NULL AS [ExtAttribute3],
           pcc.AccountId AS [ExtAttribute4],
           ...
           [pcc].[CreatedById] [SSCreatedBy],
           [pcc].[LastModifiedById] [SSUpdatedBy],
           [pcc].[CreatedDate] AS SSCreatedDate,
           [pcc].[LastModifiedDate] [SSUpdatedDate],
           GETDATE() AS createdDate,
           pcc.IsDeleted AS IsDeleted,
           NULL [AccountId],
           CASE
               WHEN pca.IsPersonAccount = 0 THEN
                   1
               ELSE
                   0
           END IsBusiness,
           pcc.AccountId AS customer_matchkey
    FROM IndianapolisColts_Reporting.prodcopy.Contact pcc
        LEFT JOIN IndianapolisColts_Reporting.prodcopy.Account pca
            ON pcc.AccountId = pca.Id
    WHERE 1 = 1
--	AND (pcc.CreatedDate > DATEADD(DAY,-3,GETDATE()) 
--		 OR pcc.LastModifiedDate > DATEADD(DAY,-3,GETDATE()) 
--		 OR pcc.CopyLoadDate > DATEADD(DAY,-3,GETDATE()) 
--		 OR pca.CopyLoadDate > DATEADD(DAY,-3,GETDATE())
--		 )
