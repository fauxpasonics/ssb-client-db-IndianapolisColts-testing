...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Creat__4C6B5938] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Updat__4D5F7D71] DEFAULT (getdate()),
