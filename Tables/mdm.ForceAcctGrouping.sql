...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Creat__46B27FE2] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Updat__47A6A41B] DEFAULT (getdate()),
