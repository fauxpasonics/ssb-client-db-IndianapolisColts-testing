...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceHous__Creat__489AC854] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceHous__Updat__498EEC8D] DEFAULT (getdate()),
